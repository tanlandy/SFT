...
dataset_file = "/data/models/datasets/OpenHermes/openhermes2_5.json"
...
train_indices = range(0, 80000)
test_indices = range(80000, 100000)

dataset_dict = {
    "train": raw_datasets["train"].select(train_indices),
...
training_args = TrainingArguments(
    ...
    # push_to_hub=True,
    # hub_model_id="linlinlin/zephy_SFT_Hermes",
